...
${[`*\`unete a nuestro grupo ay encontraras el bot oficial\`*\nhttps://chat.whatsapp.com/DmaLM7iLSFKKi7RkqUkv71`, `Unirte a nuestro canal de WhatsApp y informarte de todas la novedades/Actualizaciones del bot y mas\nhttps://whatsapp.com/channel/0029Vaqe1Iv65yDAKBYr6z0A`, `❤me puedes seguir en tiktok\nhttps://www.tiktok.com/@meliodas502chapin`].getRandom()}
...
.replace(/%islimit/g, menu.limit ? '(➬⃢⃞⃟💎)' : '')
.replace(/%isPremium/g, menu.premium ? '(➬⃢⃞⃟💵)' : '')
.trim()}).join('\n')
}),
footer
].join('\n')}),
