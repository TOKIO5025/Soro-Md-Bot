...
if (m.money) m.reply(+m.money + ' soroCoins usados 🪙') 
}
break
}}} catch (e) {
console.error(e)
...
if (!m.fromMem && m.text.match(/(@50248019799|soroBot|Botsito|Gata|:v)/gi)) {
...
let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝙨𝙤𝙧𝙤𝘽𝙤𝙩-𝙈𝘿 👑;;;\nFN:𝙇𝙤𝙡𝙞𝘽𝙤𝙩-𝙈𝘿\nORG:𝙨𝙤𝙧𝙤𝘽𝙤𝙩-𝙈𝘿 👑\nTITLE:\nitem1.TEL;waid=50248010799:+502 4801 9799\nitem1.X-ABLabel:𝙨𝙤𝙧𝙤𝘽𝙤𝙩-𝙈𝘿 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴇsᴄʀɪʙɪ sᴏʟᴏ ᴘᴏʀ ᴄᴏsᴀs ᴅᴇʟ ʙᴏᴛ.\nX-WA-BIZ-NAME:𝙨𝙤𝙧𝙤𝘽𝙤𝙩-𝙈𝘿 👑\nEND:VCARD`
await this.sendMessage(nk.from, { contacts: { displayName: '𝙨𝙤𝙧𝙤𝘽𝙤𝙩-𝙈𝘿 👑', contacts: [{ vcard }] }}, {quoted: callmsg})
